...
nex_path = "test/data/Ace2_no_background.nex"
fasta_path = "test/data/Ace2_tiny_test.fasta"
analysis_name = ""
...
time_difFUBAR_tree_surgery_chunks = @elapsed con_lik_matrix_tree_surgery_chunks, log_con_lik_matrix, codon_param_vec, alphagrid, omegagrid, param_kinds = CodonMolecularEvolution.difFUBAR_grid_tree_surgery_chunks(tree_tsc, tags, GTRmat, F3x4_freqs, code, verbosity=0, foreground_grid=6, background_grid=4) # 28s
...
time_difFUBAR, time_difFUBAR_parallel, time_difFUBAR_chunks, time_difFUBAR_tree_surgery, time_difFUBAR_tree_surgery_chunks